...
const Message = () => {
    ...
    return (
    <motion.div 
        className={`absolute right-[25%] bottom-[35%] z-10 flex flex-col items-end opacity-50 hover:cursor-pointer hover:scale-105 hover:opacity-90 transition-all ${!visibility && "hidden"}`}
    >
        ...
        <div className="bg-tertiary p-2 rounded-xl mt-0 w-100 flex flex-row items-center">
            <p className="pl-4 px-1 text-gray-400 text-[12px] text-center">drag me with your left / right mouse click   
            </p>
            <svg 
